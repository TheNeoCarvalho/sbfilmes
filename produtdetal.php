...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu" class="ddsmoothmenu">
        <ul>
            ...
            <li><a href="filmes.php" class="selected">Filmes</a>
                <ul>
      ...
      <div id="newsletter">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
                <table>
                    <tr>
                        <td height="30" width="160">Valor:</td>
                        <td>R$</td>
                    </tr>
                    <tr>
            ...
            <h5><strong>Descrição do Filme</strong></h5>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur semper quam sit amet turpis rhoncus id venenatis tellus sollicitudin. Fusce ullamcorper, dolor non mollis pulvinar, turpis tortor commodo nisl, et semper lectus augue blandit tellus. Quisque id bibendum libero.</p>	
            ...
            <div class="col col_14 product_gallery"><a href="productdetail.html"><a href="productdetail.html"><img src="images/product/02.jpg" alt="Product 02" /></a></a>
              <h3><a href="productdetail.html"></a> Nome do filme</h3>
                <p class="product_price">R$ 200</p>
                <a href="alugarfilme.php" class="add_to_cart">Alugar</a>            </div>        	
      <div class="col col_14 product_gallery no_margin_right">
            	<a href="productdetail.html"><img src="images/product/03.jpg" alt="Product 03" width="144" height="198" /></a>
                <h3><a href="productdetail.html"></a> Nome do filme</h3>
                <p class="product_price">R$ 120</p>
                <a href="alugarfilme.php" class="add_to_cart">Alugar</a>            </div>
    <a href="#" class="more float_r">Ver todasl</a>
